...
<page size="a4" style="padding:40px">
	...
	<div class="row borderBottom borderTop" style="padding-top:10px;">
        ...
        <div class="col-xs-9 content">
            ...
            <div class="header">{{$personal->fullname}}</div>
...
@endif
    ...
    <div class="row borderBottom">
        ...
        <div class="col-md-9 col-xs-9 col-lg-9 col-sm-9 col-9 content ">
    ...
    <div class="row borderBottom">
        ...
        <div class="col-xs-9 content">
            ...
            @foreach($educations as $cont)
                ...
                <div>Course: {{Content::getCourse($cont->id)}}</div>
                <div class="header">{{Content::getInstitution($cont->id)}}</div>
                <div><span>{{Content::getStartDate($cont->id)}} <b>-</b> {{Content::getEndDate($cont->id)}}</span></div>
    ...
    <div class="row borderBottom">
        ...
        <div class="col-xs-9 content">
            ...
            @foreach($skills as $cont)
                ...
                <div>{{Content::getSkill($cont->id)}}</div>
    ...
    <div class="row borderBottom">
        ...
        <div class="col-xs-9 content">
            ...
            @foreach($referees as $cont)
                ...
                <div>{{Content::getRefName($cont->id)}}</div>
