...
@section('content')
		...
		<ol class="breadcrumb">
          ...
          <!-- <button type="button" class="btn btn-sm btn-primary breadcrumb-menu" data-toggle="modal" data-target="#update">Update</button>
           ...
           -->
           <a href="{{URL::to('contents/create/'.$section->id)}}" class="btn btn-primary breadcrumb-menu">Add Skill</a>
        		 ...
        		 <div class="col-lg-4 col-sm-12">
                  ...
                  <a href="{{URL::to('contents/create/'.$section->id)}}"  style="text-decoration:none">
                    ...
                    <div class="">
                        ...
                        <div class=" small"> You have not submitted your skills. Click to update this section</div>
